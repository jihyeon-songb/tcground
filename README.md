...
**라이브:** [tcground.vercel.app](https://tcground.vercel.app/) · **UI 문서:** [tcground-docs.vercel.app](https://tcground-docs.vercel.app/)
...
| `apps/docs`         | Docusaurus 기반 `@tcground/ui` 컴포넌트 UI 문서 사이트 ([배포](https://tcground-docs.vercel.app/)) |
...
- [`tcground-docs.vercel.app`](https://tcground-docs.vercel.app/) — 배포된 `@tcground/ui` UI 문서 사이트. 설치 방법, theme CSS 적용, 컴포넌트별 사용 예시와 접근성 기준을 다룹니다.
- `pnpm docs` / `pnpm storybook` — 로컬 `@tcground/ui` 컴포넌트 문서·카탈로그

## 배포

[Vercel](https://vercel.com)에 배포되어 있습니다 → 서비스 **[tcground.vercel.app](https://tcground.vercel.app/)**, UI 문서 **[tcground-docs.vercel.app](https://tcground-docs.vercel.app/)**. UI 문서는 서비스 본체가 아니라 `packages/ui`의 `@tcground/ui` 컴포넌트 라이브러리를 설명하는 Docusaurus 정적 사이트입니다. 환경 변수와 `CRON_SECRET`을 서비스 프로젝트 설정에 등록하고, 가격 수집 크론은 [`vercel.json`](./vercel.json)에 정의되어 있습니다.
