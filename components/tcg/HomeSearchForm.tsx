...
export function HomeSearchForm({
  ...
  return (
    <form className='relative w-full' aria-label='Card search' onSubmit={handleSubmit} noValidate>
      ...
      <input
        className={`w-full rounded-full border-none bg-white text-[#191c1e] shadow-sm outline-none placeholder:text-[#535f73] focus:ring-2 focus:ring-[#bb001a] ${
          isHero
            ? 'py-5 pr-28 pl-14 text-base leading-[1.6] sm:pr-36 sm:pl-16 sm:text-lg'
            : 'py-3 pr-4 pl-12 text-base leading-[1.5]'
        }`}
        name='q'
        type='search'
        value={query}
